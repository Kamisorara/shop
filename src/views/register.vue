			...
			<div class="grid-content bg-purple">
				<el-form :model="registerForm" :rules="rules" ref="registerForm" label-width="100px"
					...
					<el-form-item label="密码" prop="password">
						<el-input v-model="registerForm.password" style="width: 300px" type="password"></el-input>
					</el-form-item>
					<el-form-item label="再次确认" prop="password2">
						<el-input v-model="registerForm.password2" style="width: 300px" type="password"></el-input>
					</el-form-item>
					<el-form-item label="邮箱" prop="email">
						<el-input v-model="registerForm.email" style="width: 300px"></el-input>
					</el-form-item>
