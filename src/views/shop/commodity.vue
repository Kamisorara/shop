	...
	<div class="main">
		<el-container>
			...
			<el-main>
				<el-carousel indicator-position="outside" style="border-radius: 30px;">
					<el-carousel-item v-for="(item, index) in imagesbox" :key="index"><img :src="item.idView" class="image" /></el-carousel-item>
				</el-carousel>
			</el-main>
			<el-aside width="200px">
				<div v-show="!isLogin">
				...
				<el-card class="box-card">
					<div slot="header" class="clearfix"><span>公告板</span></div>
		...
		<div class="content">
			<div class="show" v-for="(product, index) in products" :key="index" @click="toDetail(product.id)">
				<div class="imgbg"><el-image :src="product.photoAddr" style="height: 180px; width: 200px; margin-top: 30px"></el-image></div>
				<div class="price" style="font-size: 20px; margin-left: 15px">¥{{ product.price }}</div>
...
import { getRecommended, getAllClassification, getNotice } from '@/api/shop';
export default {
	name: 'commodity',
	data() {
		return {
